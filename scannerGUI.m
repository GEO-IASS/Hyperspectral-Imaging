...
function h1 = scannerGUI_LayoutFcn(policy)
    ...
    appdata = [];
    appdata.lastValidTag = 'reflectanceStd';

    h38 = uicontrol(...
    'Parent',h13,...
    'FontUnits',get(0,'defaultuicontrolFontUnits'),...
    'Units','characters',...
    'String','Reflectance Standard',...
    'Style',get(0,'defaultuicontrolStyle'),...
    'Position',[2 9.769230769230769 23 1.69230769230769],...
    'Callback',@(hObject,eventdata)scannerGUI('reflectanceStd_Callback',hObject,eventdata,guidata(hObject)),...
    'Children',[],...
    'ParentMode','manual',...
    'Tag','reflectanceStd',...
    'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
